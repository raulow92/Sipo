    ...
    return (
        <header className="flex mx-auto py-4 px-6 container items-center justify-between">
            ...
            <nav className={navClass}>
                ...
                <Link to="/tienda" className="md:font-normal hover:text-sky-400" onClick={handleCloseMenu}>Tienda</Link>
                <Link to="/dashboard" className="md:font-normal hover:text-sky-400" onClick={handleCloseMenu}>Dashboard</Link>
                <Link
                    to="/vender"
