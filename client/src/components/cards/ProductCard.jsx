...
const ProductCard = ({id, img, titulo, descripcion, precio, handleFavorite}) => {
    ...
    return (
        <div className="flex flex-col justify-between bg-white h-90 p-3 rounded-xl relative hover:cursor-pointer shadow-md" id={id} onClick={handleClick}> 
            <div>
                ...
                <HeartIcon id={id} className="w-6 absolute right-6 top-6 hover:text-red-600" filled={heartFill} stroke={heartStroke} onClick={handleHeartClick}/>
